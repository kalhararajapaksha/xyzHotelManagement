...
<head>
    ...
    <link rel="stylesheet" href="style/registeredusers.css">
...
<section class="section-title">
    <div class="container-fluid ">
        ...
        <h1>Reserved rooms & halls</h1>
        <h4>Check our reservations </h4>
    </div>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 text-center mb-5">
                <h2 class="heading-section">Reserved Rooms</h2>
                <p class="after-header">__________________</p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="table-wrap">
                    <table class="table">
                        ...
                        <tr class="alert" role="alert">
                            ...
                            <td>10.12.2021</td>
                            <td>
                                <input type="button" id="checkin" value="Check-In" onclick="checkinOnClick()"/>
                                <input type="button" id="checkout" value="Check-Out" onclick="checkoutOnClick()"/>
                                <input type="button" id="check-msg" value="Completed" disabled/>
                            </td>
                            <td>
...
<section class="ftco-section">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 text-center mb-5">
                <h2 class="heading-section">Reserved Conference Halls</h2>
                <p class="after-header">__________________</p>
            </div>
        </div>
        <div class="row">
...
<script src="js/button/checkinbtn.js"></script>
