 ...
 <div class="container">
    ...
    <nav id="main-menu" class="main-menu">
      <ul class="menu">
        ...
        <li class="menu-item">
          <a href="guestdetails.jsp" >CONTACT US</a>
        </li>
  ...
  <div class="slider">
    ...
    <div id="rev-slider-7" class="rev_slider color-slider gradient-slider op5"  style="display:none;" data-version="5.4.5">
     ...
     <video class="rs-background-video-layer" autoplay muted loop id="myVideo">
      <source src="images/video1.mp4" type="video/mp4" style="">
    </video>
  </div> 
          <!-- LAYER NR. 1 -->
          <div
            ...
            style="z-index: 5; font-family:Playfair Display;letter-spacing: 5px; color: #ffffff; font-weight: 400;text-align: center;">
          LIVE</div>
          <div
            class="tp-caption tp-resizeme"
            data-x="center"
        ...
        ____________________________
          ...
          <div
            ...
            data-whitespace="nowrap"
            data-frames='[{"delay":1500,"speed":1500,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
            style="z-index: 6; color:#ffffff; font-weight:400; letter-spacing: 5px;">A PLACE TO UNWIND</div>
          <!-- LAYER NR. 3 -->
          ...
          <div id="a"
            ...
            <a id="b" class="booka" href="/signin">
              BOOK NOW</a>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="room-grid-item">
                <figure class="gradient-overlay-hover link-icon">
                  <a href="room.html">
                    <img src="images/r2.jpg" class="img-fluid" alt="Image">
                  </a>
                  <div class="room-services">
                    <i class="fa fa-coffee" aria-hidden="true" data-toggle="popover" data-placement="right" data-trigger="hover" data-content="Breakfast Included" data-original-title="Breakfast"></i>
                    <i class="fa fa-wifi" aria-hidden="true" data-toggle="popover" data-placement="right" data-trigger="hover" data-content="Free WiFi" data-original-title="WiFi"></i>
            ...
            <div class="col-md-4">
              <div class="room-grid-item">
                <figure class="gradient-overlay-hover link-icon">
                  <a href="room.html">
                    <img src="images/r3.jpg" class="img-fluid" alt="Image">
                  </a>
                  <div class="room-services">
                    <i class="fa fa-coffee" aria-hidden="true" data-toggle="popover" data-placement="right" data-trigger="hover" data-content="Breakfast Included" data-original-title="Breakfast"></i>
 ...
 <section class="info services-v2 ">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-6">
              <div class="countup-box box-shadow-005">
                ...
                <span class="number" data-count="100"></span>
            ...
            <div class="col-md-6 col-sm-6 col-6">
              <div class="countup-box box-shadow-005 nom">
                ...
                <span class="number" data-count="15"></span>
  ...
  <div class="container-fluid">
    <div class="parallax-image">
        <h5>We make the ordinary, extraordinary</h5>
        <h3>Enchanted with <br>
           elegance </h3>
    </div>
</div>
</section>
        ...
        <div class="container">
          ...
          <div class="owl-carousel testimonials-owl">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="images/u1.jpg">
                </div>
                <div class="author">
                ...
                <p>We had an amazing time at the hotel. hospitality was great and we had a wonderful and relaxing vacation thanks to Heritance Lanka</p>
              </div>
            </div>
            <!-- ITEM -->
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="images/u2.jpg">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="images/u3.jpg">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="images/u4.jpg">
                </div>
                <div class="author">
                ...
                <p>We had an wonderful time at the hotel. Quality was great and we had a wonderful and relaxing vacation thanks to Heritance Lanka</p>
              </div>
            </div>
            <!-- ITEM -->
            <div class="item">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="google-map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3967.870766841685!2d80.78168041468471!3d6.012476795645359!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae14aeca9321a0d%3A0x3fa1b73e2f49fb36!2sAnantara%20Peace%20Haven%20Tangalle%20Resort!5e0!3m2!1sen!2slk!4v1638884634781!5m2!1sen!2slk" 
                width="550" height="420" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                ...
                <div class="row">
                  <div class="col-lg-6 col-sm-12">
                    <div class="contact-item">
                      ...
                      <h6>+94 775 123 456</h6>
                    </div>
                  </div>
                  <div class="col-lg-6 col-sm-12">
                    <div class="contact-item">
                      <i class="fa fa-envelope"></i>
                      <h7>contact@heritance.com</h7>
                    </div>
                  </div>
                </div>
              </div>
