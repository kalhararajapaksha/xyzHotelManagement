                ...
                <div class="vertical-booking-form slider-booking-form book-form " id="book-room-form">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="btn-td">
                                <input type="button" name="decrease" value="-" onclick="adultsdecreaseBtnOnclick()"
                                       class="addbtn"/>
                                <input type="text" name="adults" value="0" id="adults" class="inputbox"/>
                                <input type="button" name="increase" value="+" onclick="adultsincreaseBtnOnclick()"
                                       class="addbtn"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="btn-td">
                                <input type="button" name="decrease" class="addbtn" value="-"
                                       onclick="childrendecreaseBtnOnclick()"/>
                                <input type="text" name="children" value="0" id="children" class="inputbox"/>
                                <input type="button" name="increase" value="+" class="addbtn"
                                       onclick="childrenincreaseBtnOnclick()"/>
                            </td>
                        </tr>
                        <!-- <tr>
    ...
    <div class="row">
        <div class="col-lg-4">
            <table class="date-info">
                <tr>
                    <td>CHECKIN DATE</td>
                    <td><span class="check-in-date" id="checkInDate"> __/__/____</span></td>
                </tr>
                <tr>
                    <td>CHECKOUT DATE</td>
                    <td><span class="check-out-date" id="checkOutDate">__/__/____</span></td>
                </tr>
                <tr>
                    <td>NIGHTS</td>
                    <td><span class="night-amount" id="nightAmount">__</span></td>
                </tr>
        ...
        <div class="col-lg-4">
            <table class="book-info">
                <tr>
                    <td>ADULTS</td>
                    <td><span class="adult-amount" id="adultAmount">__</span></td>
                </tr>
                <tr>
                    <td>CHILDREN</td>
                    <td><span class="children-amount" id="childrenAmount">__</span></td>
                </tr>
                <tr>
                    <td>TOTAL ROOMS </td>
                    <td><span class="total-rooms-amount" id="totalRoomsAmount">__</span></td>
                </tr>
            </table>
        </div>
        <div class="col-lg-4">
            <table class="bill-info">
                ...
                <tr class="price-tr">
                    <td><span>LKR</span></td>
                    <td><span class="total-bill" id="totalBill">   0.00 </span></td>
                </tr>
            </table>
        </div>
    </div>
...
<script src="js/page/room.js"></script>
</body>
</html>