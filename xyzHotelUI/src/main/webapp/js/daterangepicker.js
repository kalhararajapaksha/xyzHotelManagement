    ...
    var a = function (a, i, s) {
        ...
        this.cancelClass.length && this.container.find(".cancelBtn").addClass(this.cancelClass),
            ...
            this.container
                ...
                .on("keydown.daterangepicker", ".daterangepicker_input input", e.proxy(this.formInputsKeydown, this)),
            this.container
                .find(".ranges")
        ...
        (a.prototype = {
            ...
            renderCalendar: function (a) {
                ...
                (this.showWeekNumbers || this.showISOWeekNumbers) && (Y += "<th></th>"),
                    (C && !C.isBefore(i.firstDay)) || (this.linkedCalendars && "left" != a) ? (Y += "<th></th>") : (Y += '<th class="prev available"><i class="fa fa-' + w.left + " glyphicon glyphicon-" + w.left + '"></i></th>');
                var P = this.locale.monthNames[i[1][1].month()] + i[1][1].format(" YYYY");
                if (this.showDropdowns) {
                    for (var M = i[1][1].month(), x = i[1][1].year(), I = (b && b.year()) || x + 5, L = (C && C.year()) || x - 50, S = x == L, A = x == I, _ = '<select class="monthselect">', B = 0; B < 12; B++)
                ...
                if (
                    ((Y += '<th colspan="5" class="month">' + P + "</th>"),
                        (b && !b.isAfter(i.lastDay)) || (this.linkedCalendars && "right" != a && !this.singleDatePicker)
                            ? (Y += "<th></th>")
